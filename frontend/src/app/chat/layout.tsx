    ...
    <>
      ...
      <section className="h-screen w-screen overflow-hidden">
        <div className="flex h-full">
          ...
          <aside
            className={`${
              isSidebarOpen ? "md:w-72" : "w-20"
            } flex flex-col justify-between border-r border-white-400 transition-width duration-100`}
          >
            <div>
              {/* Logo */}
              {isSidebarOpen ? (
                <img className="mx-auto mt-10" src="logo.svg" alt="logo" />
              ) : (
                <img
          ...
          {/* Main Content */}
          <main
            className={`bg-sea-master-blue-medium relative transition-all duration-100 ease-in-out flex-1 p-10 ${
